...
urlpatterns = [
    ...
    path('team/<int:team_id>/post_detail/<int:post_id>/delete_comment_post/<int:comment_id>/', views.delete_comment_post, name='delete_comment_post'),
    # problem & code
    ...
    path('team/<int:team_id>/problem/<int:problem_number>/code/<str:codes_string>/code_add/<str:code_id>', views.problem_with_code_add, name='problem_with_code_add'),
    path('team/<int:team_id>/problem/<int:problem_number>/code/<str:codes_string>/code_sub/<str:code_id>', views.problem_with_code_sub, name='problem_with_code_sub'),
    # comment problem
    path('team/<int:team_id>/problem/<int:problem_number>/code/<str:codes_string>/delete_comment_problem/<int:comment_problem_id>/', views.delete_comment_problem, name='delete_comment_problem'),
