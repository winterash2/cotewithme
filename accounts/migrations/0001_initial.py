    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.Team')),
            ],
        ),
        migrations.CreateModel(
            name='JoinedTeam',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField()),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('chat_channel_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.ChatChannel')),
            ],
        ),
    ]
